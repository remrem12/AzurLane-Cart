                    ...
                    <ul className="nav navbar-nav nav-flex-icons ml-auto">
                        <li className="nav-item dropdown">
                            <a href = '/' className="nav-link dropdown-toggle waves-effect waves-light" id="dropdownMenu1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <i className="fa fa-user" /> Acount</a>
                            <div className="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenu1">
                                <a href = '/' className="dropdown-item waves-effect waves-light">Sign up</a>
                                <a href = '/' className="dropdown-item waves-effect waves-light">Sign in</a>
                                <a href = '/' className="dropdown-item waves-effect waves-light">Sign out</a>
                            </div>
                        </li>
                    </ul>
                </nav>
